package com.lalala.cms.baidutts.ttsdemo.com.baidu.speech.restapi.ttsdemo;


import com.lalala.cms.baidutts.common.ConnUtil;
import com.lalala.cms.baidutts.common.DemoException;
import com.lalala.cms.baidutts.common.TokenHolder;
...
public class TtsMain {
    ...
    private final String appKey = "ZXanAeY8GfquxaZuLXcSgKF9";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "u4dBcHbuU5SX50DaYkWoP0xSmtLVspOo";
    ...
    private void run() throws IOException, DemoException, JSONException {
        ...
        if (contentType.contains("audio/")) {
            ...
            File file = new File("C:\\Users\\wangke\\Desktop\\result." + format); // 打开mp3文件即可播放
